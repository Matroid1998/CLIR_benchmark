...
#
# Flattened qac.csv into a five-column Excel-friendly sheet (question, answer, corpus,
# question_lang, source_lang) by joining each QAC row's corpus_id against corpus.csv
# for the context text and source language.
#
# Used:     March 2026 (added and run 2026-03-14), for the first manual review pass
# Retired:  single-use export, already applied; also still carries absolute default paths from
# a different machine (/home/mohammad/...), which is a good sign of its shelf life.
# Replaced by: nothing - ad hoc export. Reading and writing corpus CSVs is core.corpus.
#
# This file is a verbatim copy from the old repo (Multi-Lingual-QAC),
# original path: scripts/export_qac_for_excel.py
